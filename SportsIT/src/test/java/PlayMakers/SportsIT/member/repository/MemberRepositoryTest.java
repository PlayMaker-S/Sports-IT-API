...
class MemberRepositoryTest {
    ...
    void 사용자_정보_수정() {
        //given
        Member member = new Member(1L, "test_id", "test", "홍길동", MemberType.선수, "abcd@ajou.ac.kr", "010-1234-5678");
        ...
        //when
        Member member2 = new Member(2L, "test_id2", "test", "홍길동", MemberType.선수, "abcd@ajou.ac.kr", "010-1234-5678");
